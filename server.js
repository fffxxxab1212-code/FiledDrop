...
// Nécessaire derrière un reverse proxy (Render, Nginx...) pour que les
...
app.use(
  cors({
    origin: config.corsOrigins.length > 0 ? config.corsOrigins : config.publicUrl,
    methods: ['GET', 'POST', 'DELETE'],
    credentials: false, // aucune notion de session/cookie
  })
);
